...
*/
setReadOnly( ns, 'dmaxSorted', require( '@stdlib/stats-strided-dmax-sorted' ) );
...
*/
setReadOnly( ns, 'dmaxabsSorted', require( '@stdlib/stats-strided-dmaxabs-sorted' ) );
...
*/
setReadOnly( ns, 'dmidrangeabs', require( '@stdlib/stats-strided-dmidrangeabs' ) );
...
*/
setReadOnly( ns, 'dnanmskmaxabs', require( '@stdlib/stats-strided-dnanmskmaxabs' ) );
...
*/
setReadOnly( ns, 'dnanmskminabs', require( '@stdlib/stats-strided-dnanmskminabs' ) );
...
*/
setReadOnly( ns, 'dnanrangeabs', require( '@stdlib/stats-strided-dnanrangeabs' ) );
...
*/
setReadOnly( ns, 'dpcorr', require( '@stdlib/stats-strided-dpcorr' ) );
...
*/
setReadOnly( ns, 'midrangeabs', require( '@stdlib/stats-strided-midrangeabs' ) );
...
*/
setReadOnly( ns, 'mskminabs', require( '@stdlib/stats-strided-mskminabs' ) );
...
*/
setReadOnly( ns, 'nanrangeabs', require( '@stdlib/stats-strided-nanrangeabs' ) );
...
*/
setReadOnly( ns, 'snanmskmaxabs', require( '@stdlib/stats-strided-snanmskmaxabs' ) );
...
*/
setReadOnly( ns, 'snanmskminabs', require( '@stdlib/stats-strided-snanmskminabs' ) );

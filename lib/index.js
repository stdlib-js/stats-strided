...
*/
setReadOnly( ns, 'dnancount', require( '@stdlib/stats-strided-dnancount' ) );
...
*/
setReadOnly( ns, 'nancount', require( '@stdlib/stats-strided-nancount' ) );
...
*/
setReadOnly( ns, 'snancount', require( '@stdlib/stats-strided-snancount' ) );
